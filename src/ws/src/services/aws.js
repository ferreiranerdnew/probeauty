...
module.exports = {
    // informaçõe sreferente ao usuario criado no AWS IAM e colocado no gruopo 
  IAM_USER_KEY: 'AKIAZUSMFTGILDIWCNEG',
  IAM_USER_SECRET: '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',
  BUCKET_NAME: 'pro-beauty-dev',
